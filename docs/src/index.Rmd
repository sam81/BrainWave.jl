...
```{julia; fig_cap="Grand average for channel POz"}
tArr = collect(0:size(ave["1"],2)-1)/sampRate + epochStart
plot(tArr, ave["1"][find(chanLabels .== "POz")[1],:], color="black")
xlabel("Time (s)"); ylabel(L"Amplitude ($\mu$V)")
```
